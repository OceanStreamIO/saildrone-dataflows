...
def process_raw_file(file_info, sonar_model=None):
    ...
    try:
        ...
        print('Starting processing of {file_info.name}')
...
def main():
    file_info = Path('/media/andrei/lenovops8/DATA/saildrone/SD_TPOS2023_v03-Phase0-D20230826-T015958-0.raw')
    process_raw_file(file_info, SONAR_MODEL)
